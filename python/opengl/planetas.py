...
profundidad = -70
sun   = planet(coord(0.0, 0.0, profundidad), 	2, 	mass=100000,	name="Sun")
earth = planet(coord(0.0, 20.0, profundidad), 	1, 	mass=2000,	name="Earth", 	vel=coord(-3,0,0))
moon  = planet(coord(0.0, 28.0, profundidad), 	0.5, 	mass=100,	name="Moon",	vel=coord(-5,0,0))
